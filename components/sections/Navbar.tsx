...
export default function Navbar({ locale }: NavbarProps) {
  ...
  // true = Artistes (artists.artysmusic.com), false = Fans (artysmusic.com)
  ...
  const handleToggle = () => {
    ...
    setIsArtists(next);
    // Redirection après un court délai pour laisser l'animation se jouer
    setTimeout(() => {
