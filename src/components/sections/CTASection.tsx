      ...
      <div className="container">
        ...
        {!submitted ? (
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                style={{ ...inputBase, borderColor: errors.artistName ? 'var(--accent-red)' : 'var(--border)' }}
            ...
            <div>
              ...
              <input
                ...
                style={{ ...inputBase, borderColor: errors.email ? 'var(--accent-red)' : 'var(--border)' }}
                onFocus={e => inputFocusStyle(e.target)}
            ...
            <div>
              <label style={{
                ...
                <span style={{
                  color: 'var(--accent)', fontSize: '0.7rem', letterSpacing: '0.06em',
                  fontWeight: 500, textTransform: 'none', fontFamily: 'var(--font-mono)',
                }}>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <select
                  {...register('genre')}
                  style={{ ...inputBase, borderColor: errors.genre ? 'var(--accent-red)' : 'var(--border)', color: 'var(--text)', cursor: 'pointer', paddingRight: '44px' }}
                  onFocus={e => inputFocusStyle(e.target)}
                ...
                <span style={{
                  ...
                  color: 'var(--accent)', fontSize: '0.7rem', pointerEvents: 'none', userSelect: 'none',
                }}>
                  ▼
                </span>
              </div>
            ...
            <button
              ...
              style={{
                ...
                color: '#000', fontFamily: 'var(--font-title)', fontWeight: 900,
          ...
          <div className="cta-anim" style={{
            maxWidth: 'min(520px, 100%)', margin: '0 auto',
            ...
            border: '1px solid var(--accent-border)', borderRadius: '16px', opacity: 0,
          }}>
            <div style={{ fontSize: '2.5rem', marginBottom: '16px', lineHeight: 1 }}>✦</div>
            <div style={{
              fontFamily: 'var(--font-title)', fontWeight: 900, fontSize: '1.4rem',
              color: 'var(--accent)', letterSpacing: '-0.01em', marginBottom: '12px', textTransform: 'uppercase',
            }}>
              {t('form_success_title')}
            </div>
            <p style={{
              color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: 1.65, fontFamily: 'var(--font-body)',
            }}>
              {t('form_success_body')}
            </p>
          </div>
        ...
        <p className="cta-anim" style={{
          marginTop: '40px', fontSize: '0.78rem', color: 'var(--text-dim)',
